...
namespace Sozdanie_Raspisaniya_Proizvodstva_Nomenklatury
{
    public partial class Form1 : Form
    {
        ...
        //читает очередь заадач из переданного листа Excel
        //в очередь qTasks
        ...
        private void btnCalc_Click(object sender, EventArgs e)
        {
            ...
            while (qTasks.Count > 0)
            {
                ...
                if (i == arrTools.Count)
                {
                    ...
                    MessageBox.Show(
                        String.Format("Внимание! Для задачи №{0} ({1}) не нашлось подходящего инструмента, способного её обработать.", Tasks._id, Tasks._tnNomenclature._sName),
        ...
        private void ShowReport()
        {
            ...
            //пишем названия слесарей и рисуем горизонтальные оси
            for (int i = 0; i < arrTools.Count; ++i)
            {
                //горизонтальная ось
